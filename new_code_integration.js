...
window._wfx_settings['d1ab2ee0-8afb-11e6-a787-04013d24cf02'] = [
    ...
    [],
    /*02*/
    ["#action:pfm.portfolioList"],
    /*03*/
    ["#action:pfm.portfolioDefaultTab", "#action:pfm.portfolioProperties"],
    /*04*/
    ["#action:pfm.portfolioDefaultTab", "#action:pfm.portfolioProperties"],
    /*05*/
    ["#action:pfm.portfolioDefaultTab", "#action:pfm.portfolioProperties"],
    ...
    ["#action:pfm.portfolioDefaultTab", "#action:pfm.portfolioProperties"],
    /*08*/
    ["#action:pfm.portfolioInvestments"],
    /*09*/
    ["#action:pfm.portfolioWorksheet"],
    /*10*/
    ["#action:pfm.portfolioContentsEditor"],
    /*11*/
    ["#action:pfm.portfolioContentsEditor"],
    /*12*/
    ["#action:pfm.portfolioContentsEditor"],
    ...
    ["#action:pfm.portfolioContentsEditor"],
    /*15*/
    ["#action:pfm.portfolioProperties"],
    /*16*/
    ["#action:pfm.portfolioProperties"],
    /*17*/
    ["#action:nmc.reportAccess"],
    /*18*/
    ["#action:nmc.reportAccess"],
    /*19*/
    ["#action:nmc.reportAccess"],
...
window._wfx_settings['06bd5ca0-86fd-11e6-b370-04013d24cc02'] = [
    ...
    ["#action:pma.ideaList"],
    /*03*/
    ["#action:pma.ideaProperties"],
    /*04*/
    ["#action:projmgr.npioStaffing.id"],
    /*05*/
    ["#action:projmgr.npioStaffing.id"],
    /*06*/
    ["#action:projmgr.npioStaffing.id"]
...
window._wfx_settings['2c7450c0-8496-11e6-ae8d-04013d24cf02'] = [
    ...
    [],
    /*02*/
    ["#action:mainnav.work&classCode=project"],
    /*03*/
    ["#action:projmgr.projectDefaultTab", "#action:projmgr.projectProperties", "#action:projmgr.projectDashboard"],
    /*04*/
    ["#action:itl.riskList"],
    /*05*/
    ["#action:itl.riskList"],
    /*06*/
    ["#action:itl.issueList"],
    /*07*/
    ["#action:itl.issueObject"],
    /*08*/
    ["#action:itl.issueObject"],
    /*09*/
    ["#action:itl.issueObject"],
...
window._wfx_settings['634f9870-912f-11e6-b370-04013d24cc02'] = [
    ...
    [],
    /*02*/
    ["#action:itl.incidentList"],
    /*03*/
    ["#action:itl.incidentList"],
    /*04*/
    ["#action:itl.selectConvertType"],
    /*05*/
    ["#action:itl.selectConvertType"],
    /*06*/
    ["#action:projmgr.projectNew"]
]
...
window._wfx_settings['becbaa30-8956-11e6-a787-04013d24cf02'] = [
    ...
    ["#action:itl.incidentList"],
    /*04*/
    ["#action:itl.chooseProjectForTask"],
    /*05*/
    ["#action:itl.chooseProjectForTask"],
    /*06*/
    ["#action:projmgr.taskProperties"],
    /*07*/
    ["#action:projmgr.taskProperties"],
    /*08*/
    ["#action:projmgr.taskProperties"],
...
window._wfx_settings['c0dd8dc0-8154-11e6-9479-04013d24cd02'] = [
    ...
    ["#action:itl.riskList"],
    /*06*/
    ["#action:itl.changeList"],
    /*07*/
    ["#action:itl.changeObject"],
    /*08*/
    ["#action:itl.changeObject"],
    /*09*/
    ["#action:itl.changeObject"],
...
window._wfx_settings['72f65ac0-977e-11e6-836b-04013d24cc02'] = [
    ...
    ["#action:projmgr.projectDefaultTab", "#action:projmgr.projectProperties", "#action:projmgr.projectDashboard"],
    /*04*/
    ["#action:dms.ProjectsFileManager"],
    /*05*/
    ["#action:dms.ProjectsaddMultipleFiles"],
    /*06*/
    ["#action:dms.ProjectsaddMultipleFiles"],
    /*07*/
    ["#action:dms.ProjectsaddMultipleFiles"],
...
window._wfx_settings['12f0f050-847c-11e6-ae8d-04013d24cf02'] = [
    ...
    ["#action:projmgr.projectDefaultTab", "#action:projmgr.projectProperties", "#action:projmgr.projectDashboard"],
    /*05*/
    ["#action:projmgr.projectProperties&odf_view"],
    /*06*/
    ["#action:odf.subObjectProperties&odf_code=cop_prj_statusrpt"],
    /*07*/
    ["#action:odf.subObjectProperties&odf_code=cop_prj_statusrpt"]
...
window._wfx_settings['87329a20-8186-11e6-ae8d-04013d24cf02'] = [
    ...
    ["#action:mainnav.work&classCode=project"],
    /*03*/
    ["#action:projmgr.projectNew&partition"],
    /*04*/
    ["#action:projmgr.projectNew&partition"],
    /*05*/
    ["#action:projmgr.projectNew&partition"],
...
window._wfx_settings['3e5a4420-99cc-11e6-a426-04013d24cc02'] = [
    ...
    ["#action:projmgr.roster"],
    /*05*/
    ["#action:collab.projectParticipants"],
    /*06*/
    ["#action:collab.projectParticipants"],
    /*07*/
    ["#action:collab.makeManagerConfirmation"],
    /*08*/
    ["#action:collab.projectParticipants", "#action:collab.makeManagerConfirmation"]
...
window._wfx_settings['9748f410-80b7-11e6-a47d-04013d24cc02'] = [
    ...
    ["#action:mainnav.work&classCode=project"],
    /*03*/
    ["#action:projmgr.projectProperties", "#action:projmgr.projectDefaultTab", "#action:projmgr.projectDashboard"],
    /*04*/
    ["#action:projmgr.projectProperties"],
    /*05*/
    ["#action:projmgr.baselineRevisionList"],
    /*06*/
    ["#action:projmgr.baselineRevisionProperties"],
    /*07*/
    ["#action:projmgr.baselineRevisionProperties"],
    /*08*/
    ["#action:projmgr.baselineRevisionProperties"],
...
window._wfx_settings['4be97380-84b0-11e6-a247-04013d24cc02'] = [
    ...
    ["#action:mainnav.work&classCode=project"],
    /*03*/
    ["#action:projmgr.selectProjectTemplate&cancelAction"],
    /*04*/
    ["#action:projmgr.selectProjectTemplate&cancelAction"],
    /*05*/
    ["#action:projmgr.projectNew&template"],
    /*06*/
    ["#action:projmgr.projectNew&template"],
    /*07*/
    ["#action:projmgr.projectNew&template"]
...
window._wfx_settings['bd1dfc60-8965-11e6-a787-04013d24cf02'] = [
    ...
    [],
    /*02*/
    ["#action:projmgr.programs"],
    /*03*/
    ["#action:projmgr.programNew"],
    /*04*/
    ["#action:projmgr.programNew"],
    /*05*/
    ["#action:projmgr.programNew"],
...
window._wfx_settings['23bc09d0-80c4-11e6-90aa-04013d24cf02'] = [
    ...
    ["#action:projmgr.roster"],
    /*05*/
    ["#action:projmgr.getResourceProjectObjectList"],
    /*06*/
    ["#action:projmgr.getResourceProjectObjectList"],
    /*07*/
    ["#action:projmgr.getResourceProjectObjectList"],
...
window._wfx_settings['b3a59dd0-84a3-11e6-a247-04013d24cc02'] = [
    ...
    ["#action:projmgr.projectDefaultTab", "#action:projmgr.projectProperties", "#action:projmgr.projectDashboard"],
    /*04*/
    ["#action:revmgr.costplanList.project"],
    /*05*/
    ["#action:revmgr.costplanProperties"],
    /*06*/
    ["#action:revmgr.costplanProperties"],
    /*07*/
    ["#action:revmgr.costplanProperties"],
    ...
    ["#action:revmgr.costplanProperties"],
    /*10*/
    ["#action:revmgr.costplandetailList"],
    /*11*/
    ["#action:revmgr.costplandetailList"],
    /*12*/
    ["#action:revmgr.populateFromResourcePlan"],
    /*13*/
    ["#action:revmgr.costplanProperties"],
    /*14*/
    ["#action:revmgr.costplanProperties"]
...
window._wfx_settings['5dac4a20-83cf-11e6-ba2f-04013d24cd02'] = [
    ...
    ["#action:revmgr.costplanList.project"],
    /*06*/
    ["#action:revmgr.benefitplanList"],
    /*07*/
    ["#action:revmgr.benefitplanProperties"],
    /*08*/
    ["#action:revmgr.benefitplanProperties"],
    /*09*/
    ["#action:revmgr.benefitplanProperties"],
